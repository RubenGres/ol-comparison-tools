 ...
 *
 * @constructor
 * @extends {module:ol/control/Toggle}
...
var ol_control_HistogramMatching = class HistogramMatching extends ol.control.Toggle {
  constructor(options) {
    if (!options) {
      options = {};
    }
   ...
   * @private
   */
  getInverseValue_(value, inverse_values) {
